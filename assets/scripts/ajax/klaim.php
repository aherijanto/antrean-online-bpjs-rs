...
ini_set("display_errors","On");
	...
	if($_POST['layanan']){
        // /Monitoring/Klaim/Tanggal/{Parameter 1}/JnsPelayanan/{Parameter 2}/Status/{Parameter 3}
					$url = "https://apijkn-dev.bpjs-kesehatan.go.id/vclaim-rest-dev/Monitoring/Kunjungan/Tanggal/".$_POST['tgl']."/JnsPelayanan/".$_POST['layanan']."/Status/".$_POST['status'];
                	$nik = new Encoded($url);
					$nik->setInit();
