    ...
    <div class="row">
        <div class="col">
            <div class="card card-stats ml-4 mt-2 mb-3 p-3">
                <div style="padding-top:40px;color:#7209b7;font-size:32px;">NON BPJS</div>
                
                <div class="input-group mb-3">
                    <div class="input-group-prepend">
                        <span class="input-group-text bg-primary text-white" id="basic-addon3" hidden>Kode Booking</span>
                    </div>
                    <input type="text" class="form-control" id="kodebooking" aria-describedby="basic-addon3" hidden>
                </div>

                <div class="input-group mb-3">
                    <div class="input-group-prepend">
                        <span class="input-group-text bg-primary text-white" id="basic-addon3" hidden>Jenis Pasien</span>
                    </div>
                    <select class="form-select form-select-sm" aria-label=".form-select-sm example" id="jenispasien" hidden>
                        <option value=" ">Please Choose..</option>
                        <option value="JKN">1. JKN</option>
                        <option value="NON JKN" selected>2. NON JKN</option>
                    </select>
                </div>

                <div class="input-group mb-3">
                    <div class="input-group-prepend">
                        <span class="input-group-text bg-primary text-white" id="basic-addon3" hidden>No. Kartu BPJS</span>
                    </div>
                    <input type="text" class="form-control" id="nomorkartu" aria-describedby="basic-addon3" value="0" hidden>
                </div>
                ...
                <div class="input-group mb-3">
                    ...
                    <select class="form-select form-select-sm" aria-label=".form-select-sm example" id="kodepoli">
                        <option value=" ">Please Choose..</option>
                ...
                <div class="input-group mb-3">
                    ...
                    <select class="form-select form-select-sm" aria-label=".form-select-sm example" id="kodedokter">
...
<script src="../assets/scripts/js/nonbpjs.js"></script>