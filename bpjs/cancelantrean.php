    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="card ml-4 p-3">
                <div style="padding-top:40px;color:#7209b7;font-size:32px;">BATAL ANTREAN</div>
                ...
                <div>
                    <div class="row justify-content-center">
                        <div class="col"></div>
                        <div class="col"><button class="btn btn-danger" id="btninsert">Cancel Antrean</button></div>
                        <div class="col"></div>
                    </div>
                </div>
...
<script src="../assets/scripts/js/batalantrean.js"></script>